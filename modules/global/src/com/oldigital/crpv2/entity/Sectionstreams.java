...
@Table(name = "sectionstreams")
@Entity(name = "crpv2$Sectionstreams")
public class Sectionstreams extends BaseIntIdentityIdEntity implements Versioned, SoftDelete, Updatable, Creatable {
    private static final long serialVersionUID = 2061476291475800460L;
