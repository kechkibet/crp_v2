...
@Table(name = "sectioncollectors")
@Entity(name = "crpv2$Sectioncollectors")
public class Sectioncollectors extends BaseIntIdentityIdEntity implements Versioned, SoftDelete, Updatable, Creatable {
    private static final long serialVersionUID = -8003556685430708185L;
